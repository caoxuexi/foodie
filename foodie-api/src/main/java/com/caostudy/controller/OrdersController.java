...
//        CookieUtils.setCookie(request,response,FOODIE_SHOPCART,"",true);
        ...
        ResponseEntity<CaoJSONResult> responseEntity =
                restTemplate.postForEntity(paymentUrl,
                        entity,
                        CaoJSONResult.class);

        CaoJSONResult paymentResult=responseEntity.getBody();
        if(paymentResult.getStatus()!=200){
            return CaoJSONResult.errorMsg("支付中心订单创建失败，请联系管理员！");
        }
