...
import com.caostudy.controller.BaseController;
import com.caostudy.pojo.Users;
import com.caostudy.pojo.bo.center.CenterUserBO;
import com.caostudy.resource.FileUpload;
...
/**
 * @author Cao Study
 * @description CenterUserController
...
public class CenterUserController extends BaseController {
    ...
    public CaoJSONResult update(
        ...
        if (result.hasErrors()) {
            ...
            return CaoJSONResult.errorMap(errorMap);
        }

        Users userResult = centerUserService.updateUserInfo(userId, centerUserBO);
        // 把结果中的敏感信息都去除掉，设置为null
        userResult = setNullProperty(userResult);
        // 把新的userResult写回cookie里
    ...
    public CaoJSONResult uploadFace(
            @ApiParam(name = "userId", value = "用户id", required = true)
            @RequestParam String userId,
        ...
        if (file != null) {
            ...
            try {
                ...
                if (StringUtils.isNotBlank(fileName)) {
                    // 按文件后缀名前的.进行分割  imooc-face.png -> ["imooc-face", "png"]
                    ...
                    if (!suffix.equalsIgnoreCase("png") &&
                        ...
                        return CaoJSONResult.errorMsg("图片格式不正确！");
                    }
            ...
            return CaoJSONResult.errorMsg("文件不能为空！");
        }
